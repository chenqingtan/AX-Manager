...
public abstract class V1SchemeSigner {
    ...
    public static OutputManifestFile generateManifestFile(
        ...
        try {
			...
			//ManifestWriter.writeMainSection2(manifestOut,mainAttrs);
        } catch (IOException e) {
        ...
        for (String entryName : sortedEntryNames) {
            ...
            entryAttrs.putValue(
                    ...
                    Base64.encodeToString(entryDigest,2));
    ...
    private static byte[] generateSignatureFile(
        ...
        mainAttrs.putValue(
                ...
                Base64.encodeToString(md.digest(manifest.contents),2));
        ...
        for (Map.Entry<String, byte[]> manifestSection
            ...
            attrs.putValue(
                    entryDigestAttributeName,
                    Base64.encodeToString(sectionDigest,2));
